...
# f=open("Sample.txt","rb")#reading the text file in binary mode
# conn=f.read(3)
# donn=f.read()
# print(donn)
# print(conn)
#Reading a file using for loop and pointer
...
# for line in f:
#     print(line)
#print(f.readline())#this function reads a new line every time it is called
#print(f.readline())
#print(f.readline())
print(f.tell())#it tells where the file handler in pointing
print(f.readline())
print(f.tell())
f.seek(0)#this function is used to set the file handler at a particular point
print(f.readline())
#print(f.readlines())#this function reads the text in a file and stores it in a list
f.close()
#Reading a file using with block
